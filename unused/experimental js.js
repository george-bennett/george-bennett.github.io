...
function openFullScreen() {
    ...
    // Select the swiper-wrapper after the container is made visible
    let swiperWrapper = document.querySelector('.swiper-container .swiper-wrapper');
    swiperWrapper.innerHTML = ''; // Clear previous slides

    // Populate swiper slides with all images
    for (let i = 0; i < images.length; i++) {
        let slide = document.createElement('div');
        slide.classList.add('swiper-slide');

        let imgElement = document.createElement('img');
        imgElement.src = images[i].getAttribute("data-src");
        imgElement.classList.add('img-fluid');

        slide.appendChild(imgElement);
        swiperWrapper.appendChild(slide);
        console.log("data-src" + imgElement.src);
    }
        ...
        swiperInstance = new Swiper('.swiper-container', {
            ...
            on: {
                slideChange: function () {
                    currentIndex = this.realIndex; // Update the current index based on the slide
    ...
    // Update the view with details of the current image
    updateFullScreenView();
}

// Function to update the full-screen view details
function updateFullScreenView() {
    let currentImage = images[currentIndex]; // Get the current image based on the index
    console.log(currentImage);
    // Update the image in the full-screen viewer



    // Update text information
    imageDescription.innerText = currentImage.getAttribute("data-description") || "Description not available";
    imageDetails.innerText = currentImage.getAttribute("data-details") || "Details not available";
    imageCamera.innerText = "Camera: " + (currentImage.getAttribute("data-cam") || "Not specified");
    imageLens.innerText = "Lens: " + (currentImage.getAttribute("data-lens") || "Not specified");
    imageFocal.innerText = "Focal Length: " + (currentImage.getAttribute("data-focal") || "Not specified");
    imgAperture.innerText = "Aperture: " + (currentImage.getAttribute("data-aperture") || "Not specified");
}
